  ...
  const services = [
    ...
    },
    {
      ...
      features: [
        ...
        'Cloud Security Posture Management - CSPM (Protecting data, applications, and infrastructures in cloud environments through policies, controls, and technologies)',
        'AI Driven Governance, Risk and Compliance - GRC (Using AI to improve Governance, Risk Management, Compliance for better decisions and risk mitigation)',
        'Third Party Risk Management (Assessing and managing the risks associated with third-party suppliers and service providers)',
        'Brand Monitoring (Continuously tracking and analyzing public mentions of a brand to protect reputation and respond to emerging issues)'
      ],
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                ...
                <ul className="grid sm:grid-cols-2 gap-x-6 gap-y-2 mb-6 list-disc pl-5 marker:text-gray-500 text-sm text-gray-700 leading-relaxed text-justify">
                ...
                <button
                  ...
                  if (el) {
                    ...
                    el.classList.add('border-4', 'border-blue-500', 'transition-all');
                    setTimeout(() => {
                    el.classList.remove('border-4', 'border-blue-500', 'transition-all');
                    }, 2000);
                  }
                  }}
                >
                ...
                <div className="relative">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      <service.icon className={`h-5 w-5 text-${service.color.split('-')[1]}-600`} />
